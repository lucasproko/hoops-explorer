    ...
    const wrapper = shallow(
      <div>
        <TeamRosterStatsConfigModal
          ...
          onHide={() => {}}
          onSave={(l: any) => {}}
          config={{rapmPriorMode: -1, regressDiffs: -2000, showRapmDiag: false}}
          showHelp={true}
        />
      </div>
    );
    ...
    const wrapper = shallow(
      <div>
        <TeamRosterStatsConfigModal
          ...
          onHide={() => {}}
          onSave={(l: any) => {}}
          config={{rapmPriorMode: 0, regressDiffs: 0, showRapmDiag: true}}
          showHelp={false}
        />
      </div>
    );
    ...
    const wrapper = shallow(
      <div>
        <TeamRosterStatsConfigModal
          ...
          onHide={() => {}}
          onSave={(l: any) => {}}
          config={{rapmPriorMode: 0.5, regressDiffs: 2000, showRapmDiag: true}}
          showHelp={true}
        />
      </div>
    );
