...
const RosterCompareTable: React.FunctionComponent<Props> = ({
  gameFilterParams,
  rosterCompareStats,
}) => {
  const tableFields = {
  ...
  function needToLoadQuery() {
    return (
      Object.keys(rosterCompareStats.on).length == 0 &&
        ...
        <Col>
          <Card className="w-100">
            <Card.Body>
              ...
              <GenericTable
                tableCopyId="rosterBaseTable"
                tableFields={tableFields}
                tableData={tableData("baseline")}
              />
            </Card.Body>
          </Card>
        </Col>
        <Col>
          <Card className="w-100">
            <Card.Body>
              ...
              <GenericTable
                tableCopyId="rosterOnTable"
                tableFields={tableFields}
                tableData={tableData("on")}
              />
            </Card.Body>
          </Card>
        </Col>
        <Col>
          <Card className="w-100">
            <Card.Body>
              ...
              <GenericTable
                tableCopyId="rosterOffTable"
                tableFields={tableFields}
                tableData={tableData("off")}
              />
            </Card.Body>
          </Card>
        </Col>
