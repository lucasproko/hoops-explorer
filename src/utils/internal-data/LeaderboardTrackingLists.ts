...
export const PlayerLeaderboardTracking = {
  ...
  // Super seniors for 2022/23
  "__SUPER_SR_2022__": "AdSeiko:San Diego St.;AgArop:San Diego St.;MaBradley:San Diego St.;ZeJasper:Auburn;TyFagan:Ole Miss;KeObanor:Texas Tech;BrSlater:Villanova;CaDaniels:Villanova;DaSingleton:UCLA;SeTowns:Ohio St.;JuSueing:Ohio St.;YoAnei:DePaul;MaCarr:Texas;TiAllen:Texas;ChBishop:Texas;ReChaney:Houston;TaGroves:Oklahoma;ElHarkless:Oklahoma;LeBlack:North Carolina;KiClark:Virginia;JaGardner:Virginia;NoGurley:Alabama;DaQuisenberr:Fordham;BeStanley:Xavier;AdKunkel:Xavier;RaThompson:Indiana;MiKopp:Indiana;XaJohnson:Indiana;FlThamba:Baylor;CoRyan:Notre Dame;DaGoodwin:Notre Dame;JoHauser:Michigan St.;MaShaver:Boise St.;MaAshton-lan:Boston College;GiGeorge:BYU;KeMoore:Colorado St.;HuTyson:Clemson;DeJohnson:Cleveland St.;DjWilkins:Drake;RoPenn:Drake;GaSturtz:Drake;DaBrodie:Drake;CoCastleton:Florida;MyJones:Florida;FiRebraca:Iowa;CoMccaffery:Iowa;GaKalscheur:Iowa St.;AlKunc:Iowa St.;DaMcGhee:Liberty;DeWalker:Nebraska;JaPickett:Penn St.;MyDread:Penn St.;JaBurton:Pittsburgh;EdCroswell:Providence;MaGrace:Richmond;DwMurray:Rider;JaPerkins:Saint Louis;LoJohnson:Saint Mary's (CA);MaEarlington:San Diego;KhShabazz:San Francisco;JaHarris:Seton Hall;MoMathis:St. John's (NY);LiRobbins:Vanderbilt;QuMillora-br:Vanderbilt;DaWilliamson:Wake Forest;JsHamilton:Western Ky.;LuFrampton:Western Ky.;HuThompson:Wyoming",
