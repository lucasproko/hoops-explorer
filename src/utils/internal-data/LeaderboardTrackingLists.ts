...
export const PlayerLeaderboardTracking = {
  ...
  _.flatten([
    [ 
      "AnDavis+Antoine;JeCouisnard+Jerm;CoRamey+Court;MoUdeze;JaYoung+Jahmir;FrKepnang;FeOdukale;EfAbogidi;RiCouncil+Ricky;PrSpears+Primo;DaJones+David:DePaul"
    ]
  ]).join(";"),
