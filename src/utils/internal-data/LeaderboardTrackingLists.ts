...
export const PlayerLeaderboardTracking = {
  ...
  _.flatten([
    [ 
      "BrGolden;FaAimaq;BrMurray;CaSpencer;EtWright;ShGivance;TeRoberts+Terry;AnReeves+Antonio;TrNewton+Tristen;JeCouisnard+Jerm;KeBarthelemy+Keesh;JoToussaint"
    ]
  ]).join(";"),
