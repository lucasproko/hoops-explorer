...
export const PlayerLeaderboardTracking = {
  ...
  "__SUPER_SR_2022__": "GiGeorge:BYU;ZeJasper:Auburn;TyFagan:Ole Miss;CoCastleton:Florida;MyJones:Florida;KeObanor:Texas Tech;BrSlater:Villanova;CaDaniels:Villanova;DaSingleton:UCLA;SeTowns:Ohio St.;JuSueing:Ohio St.;YoAnei:DePaul;MaCarr:Texas;TiAllen:Texas;ChBishop:Texas;ReChaney:Houston;TaGroves:Oklahoma;ElHarkless:Oklahoma;DeWalker:Nebraska;LeBlack:North Carolina;KiClark:Virginia;JaGardner:Virginia;NoGurley:Alabama;DaQuisenberr:Fordham;BeStanley:Xavier;AdKunkel:Xavier;RaThompson:Indiana;MiKopp:Indiana;XaJohnson:Indiana;LiRobbins:Vanderbilt;QuMillora-br:Vanderbilt;FlThamba:Baylor;MoMathis:St. John's (NY);CoRyan:Notre Dame;DaGoodwin:Notre Dame;JaPickett:Penn St.;MyDread:Penn St.;MaShaver:Boise St.;JoHauser:Michigan St.;MaAshton-lan:Boston College;KeMoore:Colorado St.;HuTyson:Clemson;DeJohnson:Cleveland St.;DjWilkins:Drake;RoPenn:Drake;GaSturtz:Drake;DaBrodie:Drake;MiBothwell:Furman;JaSlawson:Furman;FiRebraca:Iowa;CoMccaffery:Iowa;GaKalscheur:Iowa St.;AlKunc:Iowa St.;TyGreene:Jacksonville;DaMcGhee:Liberty;JaBurton:Pittsburgh;EdCroswell:Providence;MaGrace:Richmond;DwMurray:Rider;JaPerkins:Saint Louis;LoJohnson:Saint Mary's (CA);MaEarlington:San Diego;AdSeiko:San Diego St.;AgArop:San Diego St.;MaBradley:San Diego St.;NaMensah:San Diego St.;KhShabazz:San Francisco;JaHarris:Seton Hall;DaWilliamson:Wake Forest;JsHamilton:Western Ky.;LuFrampton:Western Ky.;HuThompson:Wyoming;HuMaldonado:Wyoming",
