...
export const PlayerLeaderboardTracking = {
  ...
  _.flatten([
    [ 
      "BrGolden;SaSessoms;FaAimaq;BrMurray;CaSpencer;EtWright;ShGivance;TeRoberts+Terry;AnReeves+Antonio;TrNewton+Tristen;JeCouisnard+Jerm;KeBarthelemy+Keesh"
    ]
  ]).join(";"),
