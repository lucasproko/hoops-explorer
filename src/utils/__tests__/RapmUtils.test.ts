...
describe("RapmUtils", () => {
  ...
  test("RapmUtils - pickRidgeRegression", () => {
    const [ offResults, defResults ] = RapmUtils.pickRidgeRegression(testOffWeights, testDefWeights, testContext);
  ...
  test("RapmUtils - injectRapmIntoPlayers", () => {
    ...
    RapmUtils.injectRapmIntoPlayers(
      players, offResults, defResults, {}, testContext
    );
