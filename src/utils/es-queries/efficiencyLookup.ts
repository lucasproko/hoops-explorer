...
export const formatEfficiencyLookupResponse = function (
  response: any,
  year: String
) {
  return _.chain(response?.hits?.hits || [])
    .map((team) => {
