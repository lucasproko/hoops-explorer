...
const TeamLeaderboardPage: NextPage<Props> = ({testMode}) => {
  ...
  const thumbnailUrl = `${process.env.NEXT_PUBLIC_VERCEL_URL ? `https://${process.env.NEXT_PUBLIC_VERCEL_URL}` : "http://localhost:3000"}/thumbnails/team_leaderboard_thumbnail.png`;
  return <Container>
    <Head>
